...
'''
curl -v -X POST "http://47.104.25.10:80/10001" -H "Content-Type: application/json" --data-ascii "{\"url\":\"$pic\"}"
#curl -v -X POST "http://47.104.25.10:80/10001" -H "Content-Type: application/json" --data-ascii "{\"url\":\"$pic\",\"class1\":4,\"color_level\":0,\"style_level\":2}"
